...
export default function Hero() {
  ...
  return (
    <motion.section
      className="min-h-screen text-black flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden"
      initial="hidden"
    ...
    >
      ...
      <motion.div className="w-full max-w-4xl" variants={itemVariants}>
        ...
        >
          <div className="bg-blue-200 rounded-full p-1 text-sm sm:text-base">
            <button
        ...
        <motion.h1
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600"
          variants={itemVariants}
        >
          Revolutionize{" "}
        ...
        <motion.p
          className="text-lg sm:text-xl text-center mb-8 sm:mb-12 max-w-3xl mx-auto"
          variants={itemVariants}
        >
        ...
        >
          <Input
            ...
            required
            className="w-full sm:w-64 h-12 text-base sm:text-lg border-primary"
          />
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto h-12 px-6 sm:px-8 text-base sm:text-lg font-semibold bg-primary text-white hover:bg-blue-700 transition-colors"
          >
            {isLoading ? (
